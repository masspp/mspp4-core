...
public class PeakManager {
	...
	public boolean hasPeaks(Spectrum spectrum) {
		return this.spectrumPeakMap.containsKey(spectrum);
	}
	...
	public boolean hasPeaks(Chromatogram chromatogram) {
		return this.chromatogramPeakMap.containsKey(chromatogram);
	}
